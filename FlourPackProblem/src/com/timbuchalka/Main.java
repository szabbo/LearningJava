...
//        if goal = 9, bigCount = 2, and smallCount = 0, the method should return false because each bigCountbag is
//        5 kilos and cannot be divided. However, if goal = 9, bigCount = 1, and smallCount = 5, the method should
//        return true because 1 full bigCount bag and 4 full smallCount bags equal goal, and
...
//        canPack (-3, 2, 12); should return false since bigCount is negative.
    ...
    {
        if (bigCount < 0 || smallCount < 0 || bigCount * 5 > goal || ((bigCount * 5) + smallCount) < goal)
            return false;
